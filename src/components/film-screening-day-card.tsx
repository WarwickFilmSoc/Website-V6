  ...
  return (
    <Link href="/" className={`group ${responsiveClasses[index] || ''}`}>
      <article className="w-40 xl:w-[11.5rem] 2xl:w-52 3xl:w-60 text-left">
        ...
        <div className="mt-1 flex flex-col gap-y-1 xl:flex-row xl:items-center xl:gap-x-2 xl:space-y-0">
          <p className="text-sm 3xl:text-base flex-grow">Mon 26th</p>
          <div className="flex text-xs 2xl:text-sm gap-x-1 2xl:gap-x-2">
